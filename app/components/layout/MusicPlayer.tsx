...
export const MusicPlayer = ({
  ...
  return (
    <motion.button
      ...
      onClick={toggleMusic}
      className="fixed bottom-20 right-6 sm:bottom-6 sm:right-20 w-12 h-12 rounded-full glass border border-[#0B3D2E]/30 flex items-center justify-center z-50 hover:border-[#0B3D2E]/60 transition-colors"
        ...
        {isPlaying ? (
          ...
          >
            ...
            {[1, 2, 3].map((bar) => (
              <motion.div
                key={bar}
                className="w-1 bg-[#0B3D2E] rounded-full"
                animate={{
                  height: ["8px", "16px", "8px"],
                }}
                transition={{
