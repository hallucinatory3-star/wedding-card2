...
export const RotatingMandala = ({
  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" className="w-full h-full text-[#8B3A5A]">
        <defs>
          <pattern
          ...
          <radialGradient id={`mandala-grad-${position}`}>
            <stop offset="0%" stopColor="#8B3A5A" stopOpacity="1" />
            <stop offset="100%" stopColor="#A04A6A" stopOpacity="0.8" />
          </radialGradient>
        </defs>
