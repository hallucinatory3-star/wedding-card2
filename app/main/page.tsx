  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-background relative overflow-x-hidden w-full">
      ...
      <section className="px-4 pt-8 pb-4 flex flex-col items-center justify-center relative overflow-hidden w-full max-w-full min-h-screen">
        ...
        >
          ...
          <motion.p
            ...
            className="text-muted uppercase tracking-[0.3em] text-sm md:text-base font-inter mb-8"
          >
      ...
      <section className="py-20 md:py-32 relative">
        ...
        >
          <div className="absolute top-0 left-1/2 w-64 h-px bg-gradient-to-r from-transparent via-[#8B3A5A]/30 to-transparent" />
          <div className="absolute bottom-0 left-1/2 w-64 h-px bg-gradient-to-r from-transparent via-[#8B3A5A]/30 to-transparent" />
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="glass p-8 md:p-12 border border-[#8B3A5A]/20 relative overflow-hidden"
          >
            {/* header */}
            ...
            {/* Content */}
            <div className="space-y-6 max-w-4xl text-2xl mx-auto font-cormorant text-foreground">
              {/* Opening Line */}
              ...
              <div className="text-center space-y-2">
                <h3 className="text-4xl md:text-4xl font-playfair gradient-text">
                  Dr. Shagun
                </h3>
              ...
              <div className="text-center space-y-3 pt-4">
                <h4 className="text-2xl font-playfair gradient-text mb-3">
                  Best Compliments:
                </h4>
